...
{
public:
    DataSourceLiveVideoList(bilibili::LiveVideoListResult result):videoList(result){
    ...
    RecyclingGridItem* cellForRow(RecyclingGrid* recycler, size_t index) override{
        ...
        item->setCard(r.cover+"@672w_378h_1c.jpg",r.title,r.uname,r.area_name, r.online);
        return item;
    }
        ...
        brls::Application::pushActivity(new brls::Activity(new brls::Dropdown(
                ...
                [this](int _selected) {
                    ...
                    if(_selected == 0 && list.size() <= 1){
                        ...
                        this->live_label->setText("分区：" + this->getAreaList()[_selected]);
                },
                selected)));
        return true;
    });
