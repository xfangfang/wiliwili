...
public:
    explicit DataSourceSpaceVideoList(
...
void SpaceTab::onRecommendVideoList(
...
void SpaceTab::draw(NVGcontext* vg, float x, float y, float width, float height, brls::Style style, brls::FrameContext* ctx) {
