...
class DataSourceHotsHistoryVideoList
        : public RecyclingGridDataSource
{
public:
    DataSourceHotsHistoryVideoList(bilibili::HotsHistoryVideoListResult result):videoList(result){
...
brls::View* HomeHotsHistory::create() {
