...
namespace bilibili {
    ...
    namespace Api {
        ...
        /// 视频详情. gRPC
        static const std::string DetailGRPC = _grpcBase + "/bilibili.app.view.v1.View/View";
        /// 视频详情.
        ...
        /// 在线观看人数.
        static const std::string OnlineViewerCount = _apiBase + "/x/player/online/total";
        /// 视频播放信息.
        ...
        /// 视频播放信息.
        static const std::string PlayConfig = _appBase + "/bilibili.app.playurl.v1.PlayURL/PlayConf";
        /// 弹幕元数据.
        static const std::string DanmakuMetaData = _grpcBase + "/bilibili.community.service.dm.v1.DM/DmView";
        /// 分段弹幕.
        static const std::string SegmentDanmaku = _grpcBase + "/bilibili.community.service.dm.v1.DM/DmSegMobile";
        /// 历史记录.
        ...
        /// 获取视频点赞收藏情况
        static const std::string VideoRelation = _apiBase + "/x/web-interface/archive/relation";
        /// 获取视频弹幕
        ...
        /// 主页 推荐
        static const std::string Recommend = _apiBase + "/x/web-interface/index/top/feed/rcmd";
        /// 主页 热门 热门综合
        static const std::string HotsAll = _apiBase + "/x/web-interface/popular";
        /// 主页 热门 每周推荐列表
        static const std::string HotsWeeklyList = _apiBase + "/x/web-interface/popular/series/list";
        /// 主页 热门 每周推荐
        static const std::string HotsWeekly = _apiBase + "/x/web-interface/popular/series/one";
        /// 主页 热门 入站必刷
        static const std::string HotsHistory = _apiBase + "/x/web-interface/popular/precious";
        /// 主页 热门 用户投稿排行榜
        ...
        /// 主页 直播推荐
        static const std::string LiveFeed = _liveBase + "/xlive/app-interface/v2/index/feedV2";
        /// 主页 追番
        ...
        /// 主页 追番/影视 分类检索过滤器列表
        static const std::string PGCIndexFilter = _apiBase + "/pgc/page/index/condition";

        /// 视频 评论
        static const std::string Comment = _apiBase + "/x/v2/reply/main";
        /// 热门 - gRPC.
        static const std::string PopularGRPC = _grpcBase + "/bilibili.app.show.v1.Popular/Index";
        /// 排行榜 - Web.
        static const std::string Ranking = _apiBase + "/x/web-interface/ranking/v2";
        /// 排行榜 - gRPC.
        static const std::string RankingGRPC = _grpcBase + "/bilibili.app.show.v1.Rank/RankRegion";
        ...
        static const std::string HistoryVideo = _apiBase + "/x/web-interface/history/cursor";
        static const std::string CollectionList = _apiBase + "/x/v3/fav/folder/created/list";
        static const std::string CollectionVideoList = _apiBase + "/x/v3/fav/resource/list";
        ...
        static const std::string UserDynamicStat = _vcBase + "/dynamic_svr/v1/dynamic_svr/space_num_ex";
        ...
        static const std::string SearchHots = _apiBase + "/x/web-interface/search/square";

        /// ===
        /// 动态页API
        /// ===
        static const std::string DynamicVideo = _apiBase + "/x/polymer/web-dynamic/desktop/v1/feed/video";
        static const std::string DynamicUpList = _vcBase + "/dynamic_svr/v1/dynamic_svr/w_dyn_uplist";
